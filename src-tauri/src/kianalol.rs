...
pub const PREFERENCES_BACKUP_WINDOW_LABEL: &str = "preferences_backup";

pub fn create_preference_window(handle: AppHandle, label: &str) {
    ...
    .build()
    .expect("failed to build preferences window");
}
